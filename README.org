* Quizzical w/ React
A fun game to test your trivia! Gets the questions from the [[https://opentdb.com/][Open Trivia Database]].
I built this completely on my own as a solo project task from a course.

Here is a preview of what my app looks like:
[[file:src/assets/starter-screen-app-preview.png]]
[[file:src/assets/quiz-app-preview.png]]
[[file:src/assets/answers-app-preview.png]]
